...
export function TableList({ dataSource, onChange, column, actions }: { dataSource: any; actions: any; onChange: (page: number, sorter:any) => void; column: any }) {
    ...
    return (
        <List>
            ...
            <Table.Column<IPost>
                ...
                dataIndex={actions}
                render={(_, record) => {
                    const showAction = actions.find((element: any) => element.label === "Visualizar");
                    const editAction = actions.find((element: any) => element.label === "Editar");
                    const excluirAction = actions.find((element: any) => element.label === "Excluir");
                    return (
                        <Space>
                            {showAction && (
